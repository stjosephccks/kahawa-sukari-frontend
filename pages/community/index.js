...
const title ='EVENTS'
const text ='As I hope in thee, O Lord, inspire me with that confidence, which brings me to thy holy mountain.'
  ...
  return (
   <Layout>
    ...
    <div>
        <h1 className='text-primary mt-24 ml-3 md:text-center'>Upcoming Events</h1> 
